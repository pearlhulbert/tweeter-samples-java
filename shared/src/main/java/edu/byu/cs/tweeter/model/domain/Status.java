...
public class Status implements Serializable {
     ...
     */
    public edu.byu.cs.tweeter.model.domain.User user;
    /**
    ...
    public Status(String post, edu.byu.cs.tweeter.model.domain.User user, String datetime, List<String> urls, List<String> mentions) {
        this.post = post;
        this.user = user;
    ...
    public void setUser(edu.byu.cs.tweeter.model.domain.User user) {
        this.user = user;
    }
